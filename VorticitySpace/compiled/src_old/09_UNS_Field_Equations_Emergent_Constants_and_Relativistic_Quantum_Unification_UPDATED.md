...
|----------|----------------------|-------------|
| Quantum mechanics | $\langle \psi \mid \psi \rangle = 1$ | Local normalization of complex amplitudes |
| General relativity | $G_{\mu\nu} = \frac{8\pi G}{c^4} T_{\mu\nu}$ | Curvature of normalization manifold under energy redistribution |
| Unified Number Space | $\sum_i \lvert v_i \rvert^2 = 1$ | Completeness invariant — basis of both forms |
...
|----------|----------------|----------------|
| **Planck constant ($\hbar$)** | $\hbar \propto \frac{E_{\text{unit}}}{\omega_{\text{unit}}}$ | Ratio linking relational phase rotation to energy density |
...
| **Boltzmann constant ($k_B$)** | $k_B \propto \frac{E_{\text{redistribution}}}{S}$ | Ratio between energy redistribution and relational entropy |

All constants emerge as relational invariants under the single normalization law (\Sigma = 1).
...
| **Conservation** | Probability | Energy–momentum | Normalization (\Sigma = 1) |
...
From a single axiom—\Sigma = 1—arise:
